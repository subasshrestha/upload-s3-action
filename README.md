...
This action uploads a directory to AWS S3 with the possiblity to [publicly read it](https://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteAccessPermissionsReqd.html) and output key that generated by [shortid](https://github.com/dylang/shortid)
